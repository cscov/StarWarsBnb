...
tatooine1 = Photo.create!({url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253122/moisture_farm.jpg"})
...
tatooine3 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253124/bantha.jpg" })
tatspotphoto3 = SpotPhoto.create!({ photo_id: tatooine3.id, spot_id: spot1.id })

scarif1 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253126/scarif_facility.png"})
scarspotphoto1 = SpotPhoto.create!({ photo_id: scarif1.id, spot_id: spot6.id })
scarif2 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253126/scarif_beach.jpg"})
scarspotphoto2 = SpotPhoto.create!({ photo_id: scarif2.id, spot_id: spot6.id })
scarif3 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253159/shield_gate.png"})
scarspotphoto3 = SpotPhoto.create!({ photo_id: scarif3.id, spot_id: spot6.id })

naboo1 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253166/naboo_waterfall.jpg"})
nabspotphoto1 = SpotPhoto.create!({ photo_id: naboo1.id, spot_id: spot8.id })
naboo2 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253173/naboo_lake.png"})
nabspotphoto2 = SpotPhoto.create!({ photo_id: naboo2.id, spot_id: spot8.id })
naboo3 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253171/Theed.png"})
nabspotphoto3 = SpotPhoto.create!({ photo_id: naboo3.id, spot_id: spot8.id })

lamu1 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523402882/la_mu_beach.png"})
lamspotphoto1 = SpotPhoto.create!({ photo_id: lamu1.id, spot_id: spot3.id })
lamu2 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253144/Erso_homestead.png"})
lamspotphoto2 = SpotPhoto.create!({ photo_id: lamu2.id, spot_id: spot3.id })
lamu3 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253136/farming.png"})
lamspotphoto3 = SpotPhoto.create!({ photo_id: lamu3.id, spot_id: spot3.id })

hoth1 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253141/hoth_snowfield.jpg"})
hothspotphoto1 = SpotPhoto.create!({ photo_id: hoth1.id, spot_id: spot2.id })
hoth2 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253130/hoth_atats.jpg"})
hothspotphoto2 = SpotPhoto.create!({ photo_id: hoth2.id, spot_id: spot2.id })
hoth3 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253128/hoth_planet.jpg"})
hothspotphoto3 = SpotPhoto.create!({ photo_id: hoth3.id, spot_id: spot2.id })

endor1 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253162/ewok_village.jpg"})
endspotphoto1 = SpotPhoto.create!({ photo_id: endor1.id, spot_id: spot5.id })
endor2 = Photo.create({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253149/endor_trees.jpg"})
endspotphoto2 = SpotPhoto.create!({ photo_id: endor2.id, spot_id: spot5.id })
endor3 = Photo.create({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253159/endor_planet.png"})
endspotphoto3 = SpotPhoto.create!({ photo_id: endor3.id, spot_id: spot5.id })

bespin1 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253160/bespin_city.jpg"})
besspotphoto1 = SpotPhoto.create!({ photo_id: bespin1.id, spot_id: spot4.id })
bespin2 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253159/Bespin_skyscrapers.png"})
besspotphoto2 = SpotPhoto.create!({ photo_id: bespin2.id, spot_id: spot4.id })
bespin3 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253151/bespin_skyline.jpg"})
besspotphoto3 = SpotPhoto.create!({ photo_id: bespin3.id, spot_id: spot4.id })

achto1 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253146/ach_to_aerial.jpg"})
achspotphoto1 = SpotPhoto.create!({ photo_id: achto1.id, spot_id: spot7.id })
achto2 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253149/ach_to_huts.jpg"})
achspotphoto2 = SpotPhoto.create!({ photo_id: achto2.id, spot_id: spot7.id })
achto3 = Photo.create!({ url: "http://res.cloudinary.com/dvqilcc9p/image/upload/c_scale,h_513/v1523253136/Ahch-To_surface.png"})
...
booking1 = Booking.create!(spot_id: spot1.id, reservation_code: "DKF4IRR0",
                           traveler_id: host8.id, check_in: DateTime.civil(2018, 4, 10, 16, 0, 0),
                           check_out: DateTime.civil(2018, 4, 12, 11, 0, 0),
